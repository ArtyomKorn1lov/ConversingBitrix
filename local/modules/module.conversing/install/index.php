...
class module_conversing extends CModule
{
    public function __construct()
    {
        ...
        $this->MODULE_ID = 'module.conversing';
        // название модуля
        $this->MODULE_NAME = Loc::getMessage('CONVERSING_MODULE_NAME');
        //описание модуля
        $this->MODULE_DESCRIPTION = Loc::getMessage('CONVERSING_MODULE_DESCRIPTION');
        ...
        $this->PARTNER_NAME = Loc::getMessage('CONVERSING_MODULE_PARTNER_NAME');
    }
